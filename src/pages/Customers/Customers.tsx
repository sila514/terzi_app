                        ...
                        <div className="flex gap-2">
                          {kalan > 0 && (
                            <button onClick={() => { setSelectedOrder(order); setShowPaymentForm(true) }}
                              className="flex-1 flex items-center justify-center gap-1 bg-purple-600 hover:bg-purple-700 text-white py-2 rounded-lg text-xs md:text-sm font-medium transition-all">
      ...
      {showPaymentForm && selectedOrder && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[60] p-4">
          <div className="bg-white rounded-2xl p-7 w-full max-w-md shadow-2xl">
            ...
            <button onClick={handlePayment} className="w-full mt-4 bg-purple-600 hover:bg-purple-700 text-white font-medium py-2.5 rounded-xl transition-all">
              Kaydet
            </button>
          </div>
        </div>
      ...
      {showOrderForm && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[60] p-4">
          <div className="bg-white rounded-2xl p-7 w-full max-w-xl shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <button onClick={handleSaveOrder} className="w-full mt-6 bg-purple-600 hover:bg-purple-700 text-white font-medium py-2.5 rounded-xl transition-all">
              Kaydet
            </button>
          </div>
        </div>
      ...
      {showCustomerForm && (
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-7 w-full max-w-xl shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <button onClick={handleSaveCustomer} className="w-full mt-6 bg-purple-600 hover:bg-purple-700 text-white font-medium py-2.5 rounded-xl transition-all">
              Kaydet
            </button>
          </div>
        </div>
